...
<div class="Sidebar bg-yellow" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        <div class="icon_Home pt-1 me-4 d-flex justify-content-center">
            <a href="dashboard.php" class="fs-5 text-center text-decoration-none text-dark d-flex align-items-center nav-link">
    ...
    <div class="mt-5 bottom d-flex justify-content-center align-items-center">
        <a href="login.html" class="fs-5 text-center text-decoration-none text-dark mt-4">Logout
